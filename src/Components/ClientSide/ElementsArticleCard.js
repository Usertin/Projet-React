                            ...
                            <Col xs = {3}>
                                ...
                                <Card.Body>
                                    ...
                                    <Row>
                                        ...
                                        {props.type == "admin" && <Btn variant="info" onClick={() => nav(`/modifierArticle/${elt.id},${props.art}`)}>Modify Element</Btn>}
                                        {props.type == "admin" && <Btn variant="danger" onClick={() => nav(`/supprimerArticle/${elt}`)}>Delete Element</Btn>}
                                    </Row>
                                </Card.Body>
                                </Card>
                            </Col>
